		...
		<div class="row g-0">	<!-- Wrapper -->
			...
			<nav class="col-2 bg-light pe-3 border-right"> <!-- Left Side Nav -->
				...
				<div class="list-group text-center text-lg-start">
					...
					<a href="/admin/shop" class="list-group-item list-group-item-action active">
			...
			<main class="col-10 bg-secondary"> <!-- Main (Top Nav & Content) -->
				...
				<div class="container-fluid mt-3 p-4"> <!-- Content -->
					<div class="row mt-4 flex-column flex-lg-row"> 
                      ...
                      <th scope="col">Home Kit</th>
                      <th scope="col">Away Kit</th>
                      <th scope="col">Scarf</th>
                      <th scope="col">Phone Cover</th>
                      <th scope="col">Mug</th>
                    ...
                    <?php 
                      ...
                      ?>    
						  ...
						  <td>
							<?php if($row['homekit']!=""){echo $row['homekit'];}else{echo "-";}?>
						  </td>
                          
                          <td><?php if($row['awaykit']!=""){echo $row['awaykit	'];}else{echo "-";}?></td>
                          <td><?php if($row['scarf']!=""){echo $row['scarf'];}else{echo "-";}?></td>
                          <td><?php if($row['cover']!=""){echo $row['cover'];}else{echo "-";}?></td>
                          <td><?php if($row['mug']!=""){echo $row['mug'];}else{echo "-";}?></td>
                          <td><?php echo $row['time'];?></td>
                          <td>
							<form action="../config/shop.delete.php" method="POST">
