		...
		<div class="row g-0">	<!-- Wrapper -->
			...
			<nav class="col-2 bg-light pe-3 border-right"> <!-- Left Side Nav -->
				...
				<div class="list-group mt-4 text-center text-lg-start">
					...
					<a href="/admin/blog" class="list-group-item list-group-item-action active">
			...
			<main class="col-10 bg-secondary"> <!-- Main (Top Nav & Content) -->
				...
				<div class="container-fluid mt-3 p-4"> <!-- Content -->
					...
					<div class="row mt-4 flex-column flex-lg-row"> 
						<!-- Content Row 2 -->
						<div class="col">
							<h2 class="h6 text-white-50">Uploaded Posts</h2>
							<div class="card mb-3" >
								<div class="card-body">
									<div class="text-end">
                    ...
                    <?php 
                      ...
                      ?>    
                          ...
                          <td>
							<form action="../config/blog.delete.php" method="POST">
					...
					<form id="form" action="../config/blog.php" method="POST">
						...
						<div class="form-group">
							...
							<textarea class="form-control" name="body" id="exampleFormControlTextarea1" placeholder="Content" rows="3"></textarea>
						</div>
						<div class="form-group">
							<input type="submit" value="Submit" name="submit" class="form-control btn btn-primary mt-3">
						</div>
					</form>
					</div>
