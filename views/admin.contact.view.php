		...
		<div class="row g-0">	<!-- Wrapper -->
			...
			<nav class="col-2 bg-light pe-3 border-right"> <!-- Left Side Nav -->
				...
				<div class="list-group text-center text-lg-start">
					...
					<a href="/admin/contact" class="list-group-item list-group-item-action active">
			...
			<main class="col-10 bg-secondary"> <!-- Main (Top Nav & Content) -->
				...
				<div class="container-fluid mt-3 p-4"> <!-- Content -->
					...
					<div class="row mt-4 flex-column flex-lg-row"> 
						<!-- Content Row 2 -->
						<div class="col">
							<h2 class="h6 text-white-50">Submitted Contact Form</h2>
                    ...
                    <tr>
                      ...
                      ?>    
                          ...
                          <td><?php if($row['message'] !==""){
                            echo $row['message'];
                          }else{echo "No Comments";};?></td>
                          <td><?php echo $row['submit_time'];?></td>
                          <td>
						  	<form action="../config/contact.delete.php" method="POST">
