# Junior Mints Football Club Website

## Overview

This project implements a football club website using HTML,CSS,JS,PHP,Mailer and MySQL. I used pure JS and PHP to understand them more properly.
